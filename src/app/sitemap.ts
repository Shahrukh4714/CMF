...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://convertmyfiles.com";
  const lastMod = new Date("2026-06-28");

  const staticPages: MetadataRoute.Sitemap = [
    { url: baseUrl, lastModified: lastMod, changeFrequency: "weekly", priority: 1.0 },
    { url: `${baseUrl}/tools`, lastModified: lastMod, changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/formats`, lastModified: lastMod, changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/privacy`, lastModified: lastMod, changeFrequency: "monthly", priority: 0.3 },
  ];
